...
<div class="modal fade" id="single-data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
      <li class="list-group-item">ID: <span class="text-success" id="contactid"></span></li>
      <li class="list-group-item">Title: <span class="text-success" id="fullname"></span> </li>
      <li class="list-group-item">Author: <span class="text-success" id="contactemail"></span></li>
      <li class="list-group-item">Details: <span class="text-success" id="contactnumber"></span></li>
    </ul>
    </div>
  </div>
</div>